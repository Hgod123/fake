...
workspace_name = "shreenidhi" # PLACEHOLDER
subscription_id = "f25a1898-9f63-40ae-a387-67100694b969" # PLACEHOLDER
resource_group = "nkit" # PLACEHOLDER
experiment_name = "fake" # PLACEHOLDER
iteration = "41"  # PLACEHOLDER
run_id = "AutoML_248794d2-21c0-4174-a41c-ddad21942e26_41"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'cpu-cluster','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':30,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':2,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'fake','path':'./sample_projects/fake','primary_metric':'AUC_weighted','region':'centralindia','resource_group':'nkit','subscription_id':'f25a1898-9f63-40ae-a387-67100694b969','task_type':'classification','validation_size':0.1,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'shreenidhi','label_column_name':'Brand Name','positive_label':None,'enable_batch_run':True,'dataset_id':'70f38eaf-f736-472f-9ba2-1f8645f2f42e'} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"SparseNormalizer\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"norm\": \"l2\"}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"GradientBoostingClassifier\", \"module\": \"sklearn.ensemble\", \"param_args\": [], \"param_kwargs\": {\"criterion\": \"mse\", \"learning_rate\": 0.046415888336127774, \"max_depth\": 10, \"max_features\": 0.6, \"min_samples_leaf\": 0.01, \"min_samples_split\": 0.056842105263157895, \"n_estimators\": 400, \"subsample\": 0.33684210526315794}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"5b41652184db58765a4b1be973e29f709b16a63f\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ SparseNormalizer, GradientBoostingClassifier }\"}" # PLACEHOLDER
pipeline_id = "5b41652184db58765a4b1be973e29f709b16a63f" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"70f38eaf-f736-472f-9ba2-1f8645f2f42e\"}}" # PLACEHOLDER
